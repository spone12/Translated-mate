...
"}")
        ...
        self.offMicrophone = ClickableLabel(parent=self.horizontalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.offMicrophone.sizePolicy().hasHeightForWidth())
        self.offMicrophone.setSizePolicy(sizePolicy)
        self.offMicrophone.setMinimumSize(QtCore.QSize(35, 35))
        self.offMicrophone.setMaximumSize(QtCore.QSize(35, 35))
        self.offMicrophone.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.offMicrophone.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.offMicrophone.setAutoFillBackground(False)
        self.offMicrophone.setStyleSheet("")
        self.offMicrophone.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.offMicrophone.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.offMicrophone.setText("")
        self.offMicrophone.setTextFormat(QtCore.Qt.TextFormat.PlainText)
        self.offMicrophone.setPixmap(QtGui.QPixmap("img/offMicrophone.png"))
        self.offMicrophone.setScaledContents(True)
        self.offMicrophone.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        self.offMicrophone.setOpenExternalLinks(False)
        self.offMicrophone.setObjectName("offMicrophone")
        self.leftPanelLayout.addWidget(self.offMicrophone, 0, QtCore.Qt.AlignmentFlag.AlignTop)
...
"}")
        ...
        self.generalScrollAreaWidgetContents = QtWidgets.QWidget()
        self.generalScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1019, 429))
        self.generalScrollAreaWidgetContents.setObjectName("generalScrollAreaWidgetContents")
        self.formLayoutWidget = QtWidgets.QWidget(parent=self.generalScrollAreaWidgetContents)
        self.formLayoutWidget.setGeometry(QtCore.QRect(-1, -1, 1021, 441))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.generalFormLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.generalFormLayout.setContentsMargins(0, 0, 0, 0)
        ...
        self.generalFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.defaultTranslatorLabel)
        ...
        self.generalFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.defaultTranslatorComboBox)
        ...
        self.translateScrollArea = QtWidgets.QScrollArea(parent=self.translateTab)
        self.translateScrollArea.setGeometry(QtCore.QRect(0, 0, 1021, 431))
        self.translateScrollArea.setWidgetResizable(True)
        self.translateScrollArea.setObjectName("translateScrollArea")
        self.translateScrollAreaWidgetContents = QtWidgets.QWidget()
        self.translateScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1019, 429))
        self.translateScrollAreaWidgetContents.setObjectName("translateScrollAreaWidgetContents")
        self.formLayoutWidget_3 = QtWidgets.QWidget(parent=self.translateScrollAreaWidgetContents)
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(-1, -1, 1021, 441))
        self.formLayoutWidget_3.setObjectName("formLayoutWidget_3")
        self.translateFormLayout = QtWidgets.QFormLayout(self.formLayoutWidget_3)
        self.translateFormLayout.setContentsMargins(0, 0, 0, 0)
        self.translateFormLayout.setObjectName("translateFormLayout")
        self.translateFontSizeLabel = QtWidgets.QLabel(parent=self.formLayoutWidget_3)
        self.translateFontSizeLabel.setMinimumSize(QtCore.QSize(300, 0))
        self.translateFontSizeLabel.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.translateFontSizeLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.translateFontSizeLabel.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.translateFontSizeLabel.setScaledContents(True)
        self.translateFontSizeLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.translateFontSizeLabel.setWordWrap(False)
        self.translateFontSizeLabel.setObjectName("translateFontSizeLabel")
        self.translateFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.translateFontSizeLabel)
        self.translateFontSizeComboBox = QtWidgets.QComboBox(parent=self.formLayoutWidget_3)
        self.translateFontSizeComboBox.setObjectName("translateFontSizeComboBox")
        self.translateFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.translateFontSizeComboBox)
        self.translateScrollArea.setWidget(self.translateScrollAreaWidgetContents)
        self.settingsTabWidget.addTab(self.translateTab, "")
        self.hotkeysTab = QtWidgets.QWidget()
        self.hotkeysTab.setObjectName("hotkeysTab")
        self.settingsTabWidget.addTab(self.hotkeysTab, "")
        ...
        self.progressBar = QtWidgets.QProgressBar(parent=self.Grid)
        self.progressBar.setGeometry(QtCore.QRect(70, 470, 1010, 23))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.offMicrophone.setToolTip(_translate("MainWindow", "Stop record"))
        ...
        self.translateFontSizeLabel.setText(_translate("MainWindow", "Font size"))
        self.settingsTabWidget.setTabText(self.settingsTabWidget.indexOf(self.translateTab), _translate("MainWindow", "Translate"))
        self.settingsTabWidget.setTabText(self.settingsTabWidget.indexOf(self.hotkeysTab), _translate("MainWindow", "Hot keys"))
        ...
        self.chooseTranslator.setTitle(_translate("MainWindow", "Runtime Translator"))
